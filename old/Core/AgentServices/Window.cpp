...
std::map<uint, AudioData> AgWindow::AudioDataMap;
...
void AgWindow::PlayAudio(uint index)
{
	...
	AudioData ai = AgFile->ReadAudio(index);
	...
	AudioDataMap.insert({ channel, ai });
...
{
	AudioData* chanAi = &AudioDataMap[channel];
