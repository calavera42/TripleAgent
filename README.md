...
### Overview
Non-COM reimplementation of Microsoft Agent Technology
...
### The current implementation
  ...
  |Windowing|In progress / Windows only|Manages the Agent and Balloon windows. Currently relies on Windows APIs, but it isn't platform-specific by design.|
  |DataProvider|90% done|Responsible for parsing the Agent Character Specification (.ACS) files.|
